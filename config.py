...
class Config:
    ...
    # Set PAGEINDEX_API_KEY in .env to enable cloud mode.
    # Leave blank to use local tree-search mode (no external calls).
    # Get a key at: https://docs.pageindex.ai/quickstart
